...
🏆 **โครงงานคณิตศาสตร์ระดับม.ปลาย** - การประยุกต์ใช้ฟังก์ชันตรีโกณมิติในการวัดระยะทาง พื้นที่ และความสูง
...
- 🔢 **ทฤษฎีบทพีทาโกรัส** สำหรับการคำนวณระยะทาง
...
- 📐 โหมด: วัดระยะ, วัดพื้นที่, วัดความสูง, **วัดมุม (ตรีโกณมิติ)**
...
4. เลือกโหมดการวัด:
   - **วัดระยะทาง**: ใช้ทฤษฎีบทพีทาโกรัส + Advanced Perspective Correction
...
2. **ฟังก์ชัน Sine**: sin θ = ตรงข้าม / ด้านเอียง
3. **ฟังก์ชัน Cosine**: cos θ = ประชิด / ด้านเอียง
